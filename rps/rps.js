...
function displayFightResult(fightResult) {
    ...
    switch(fightResult) {
        case -1: 
            ...
            break
        case 0:
            msg = 'It is a <span style="color:darkgrey;">tie</spain>!'
            break
        case 1:
    ...
    let fightReultContainer = document.getElementById("fightResult")
    fightReultContainer.innerHTML = msg
}
 function saveInHistory(playerWeapon, enemyWeapon, fightResult){
     ...
     switch(fightResult){
         case -1:
             ...
             break
    case 0:
         msg = playerSpan + " has player a tie with " + enemySpan
         break
         case 1:
